...
public class H4_Fetch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1111 no'lu ogrenci: " + session.get(H1_Ogrenci.class, 1111));
        ...
        session.createQuery(hqlQuery1).getSingleResult();                     // getSingleResult() = tek satir dondurecekse tercih edilir
        ...
        //	List<H1_Ogrenci> sorgu3 = session.createQuery(hqlQuery3).getResultList(); 		// kitap class'ina dokunmadigimiz icin bu sekilde yazabiliriz
        System.out.println(sorgu3);


        // 6) kitap isimlerini getir
        String hqlQuery4 = "SELECT k.book FROM H2_Kitap k";
        List<H2_Kitap> sorgu4 = session.createQuery(hqlQuery4).getResultList();
